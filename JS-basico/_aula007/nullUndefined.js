 ...
 // variavel declarada porém não foi inicializada, ou seja declaramos mas não setamos o valor (undefined)
let valor
console.log(valor)

//variavel declarada e inicializada, porém foi atribuido o valor null(ausência de valor)
valor = null 
console.log(valor)
